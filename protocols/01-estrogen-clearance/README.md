...
>
> 🚺 **Developed without hormonal contraception or suppression.** If you are currently on BC, hormonal endo suppression, or HRT, review the supplement list with your prescriber first. See [`research/birth-control-context.md`](../../research/birth-control-context.md).
...
| Week | Focus | Goal |
|---|---|---|
| [**Week 1 — Foundation**](week-1-foundation.md) | Reduce inbound load | Eliminate the most common inflammatory food triggers and toxicant exposures |
| [**Week 2 — Activation**](week-2-activation.md) | Activate Phase 2 pathways | Add targeted methylation, conjugation, and detox-support nutrients |
| [**Week 3 — Clearance**](week-3-clearance.md) | Optimize elimination | Maximize fiber, hydration, sauna cadence; block enterohepatic recirculation |
| [**Week 4 — Integration**](week-4-integration.md) | Sustainable maintenance | Reintroduce foods strategically; identify long-term keepers |

The full mechanistic justification is in [`why-this-works.md`](why-this-works.md).
...
### 🔪 [**For people preparing for surgery**](for-pre-surgery.md)
...
### 🩹 [**For people recovering from surgery**](for-post-surgery.md)
...
### 🤔 [**For people on the fence about surgery**](for-surgery-hesitant.md)
...
Each pillar maps to a documented mechanism (see [`why-this-works.md`](why-this-works.md)):
...
### Wearable (continuous)
- Daily HRV, recovery score, resting HR, sleep duration, sleep performance (WHOOP)
- Daily resting HR, body battery, VO₂ Max, stress score (Garmin)

### Symptoms (daily, in [`tracking/`](tracking/) templates)
...
- ⭐ **Homocysteine** — single most aligned marker for protocol thesis
- ⭐ **hs-CRP** — systemic inflammation
- **Vitamin D, 25-OH**
- **Vitamin B12** + methylmalonic acid (functional B12)
- **Comprehensive metabolic panel** including liver enzymes (ALT, AST, GGT)
- **CBC with differential**
- **Ferritin**
- **Full thyroid panel** (TSH, free T4, free T3, reverse T3, TPO antibodies) — *time these to the follicular phase if possible to control for cycle-phase effects*

### Optional advanced testing (practitioner-ordered)
- **DUTCH Complete** — urine hormone metabolites; measures 2-OH : 4-OH estrogen ratio directly
- **Mosaic Diagnostics OAT** — organic acids; mitochondrial + Phase 2 markers
- **Evvy vaginal microbiome** — relevant for surgical recovery context (see [Study 001](../../studies/001-evvy-surgery-recovery/))
...
- Improvements in energy and sleep within Week 1–2
- HRV improvement on wearables by Week 2
- Bloodwork shifts in methylation markers (homocysteine, B12) at Week 4
- Reduced pelvic pain *if* food sensitivities are part of your inflammation profile

**Possible but not guaranteed:**
- Cycle pain reduction in the first cycle after the protocol
- Mood and brain-fog improvement
- Skin clarity

**Unlikely:**
- Complete symptom resolution in 30 days
- Lesion regression (the protocol may reduce inflammation; it does not directly clear endometrial lesions)
- Replacing the need for surgery if you have severe DIE or large endometriomas

**Possible negative effects:**
- Initial fatigue / "detox flu" symptoms in Week 1 (caffeine + sugar elimination)
- Headache during first 3–5 days
- Bowel changes
- ⚠️ **Worsening symptoms** — if anything gets worse, stop and consult your practitioner

---

## When to pause or stop the protocol

- Severe headache, dizziness, or fatigue beyond Week 1
- New or worsening pelvic pain
- Unexpected bleeding or cycle disruption
- Any acute illness
- Within 2 weeks of planned surgery (especially blood-thinning supplements)
- During acute infection
- If your practitioner advises against continuing
...
- [`why-this-works.md`](why-this-works.md) — full mechanistic explanation
- [`week-1-foundation.md`](week-1-foundation.md) — Days 1–7
- [`week-2-activation.md`](week-2-activation.md) — Days 8–14
- [`week-3-clearance.md`](week-3-clearance.md) — Days 15–21
- [`week-4-integration.md`](week-4-integration.md) — Days 22–30
- [`for-pre-surgery.md`](for-pre-surgery.md) — audience-specific guidance
- [`for-post-surgery.md`](for-post-surgery.md) — audience-specific guidance
- [`for-surgery-hesitant.md`](for-surgery-hesitant.md) — audience-specific guidance
- [`tracking/`](tracking/) — daily logs and templates
...
→ [**Case Study 001 — Core Restore liver cleanse (no BC)**](../../case-studies/001-core-restore-no-bc/)
